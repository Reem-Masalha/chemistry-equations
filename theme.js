...
const DESIGN=['modern-refresh.css?v=20260905-unified-site-7','site-shell.css?v=20260905-shell-parity-8'];
...
.topbar>#accountTopBtn,.topbar>#logoutTopBtn,.topbar>#site-language-control,.topbar>#themeToggle{flex-shrink:0!important}
.site-language-control{display:inline-flex!important;align-items:center!important;gap:5px!important}
.site-language-control select{height:38px!important;border:1px solid var(--line)!important;border-radius:10px!important;background:var(--surface)!important;color:var(--text)!important;padding:0 8px!important;font:inherit!important}
#themeToggle{order:999!important}
#site-language-control{order:998!important}
#logoutTopBtn{order:997!important}
#accountTopBtn{order:996!important}
...
#themeToggle{grid-column:auto!important;width:auto!important;min-width:42px!important;padding:9px 10px!important;font-size:0!important}
#themeToggle::first-letter{font-size:18px!important}
.account-top{grid-column:auto!important;width:auto!important;min-width:42px!important;padding:9px 10px!important;font-size:0!important}
.account-top::first-letter{font-size:18px!important}
#logoutTopBtn{font-size:0!important;min-width:42px!important;padding:9px 10px!important}
#logoutTopBtn::first-letter{font-size:18px!important}
...
const init=()=>{installDesign();installShellParity();normalizeLegacyHeroes();nav();apply(read());installThemeButton();reorderControls();ensureLanguageSystem();setTimeout(reorderControls,300)};
