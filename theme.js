...
const init=()=>{nav();apply(read());const b=document.getElementById('themeToggle');if(b&&!b.dataset.themeReady){b.dataset.themeReady='1';b.onclick=()=>{const next=read()==='dark'?'light':'dark';try{localStorage.setItem(KEY,next)}catch{}apply(next)}}};
