...
if(!replay)return;
const DATA=[
 ['H₂ + O₂ → H₂O'],['Na + Cl₂ → NaCl'],['Mg + O₂ → MgO'],['N₂ + H₂ → NH₃'],['Fe + O₂ → Fe₂O₃']
];
const day=()=>new Date().toISOString().slice(0,10);const idx=()=>{const a=new Date(DAY()+'T00:00:00Z'),b=new Date('2020-01-01T00:00:00Z');return Math.floor((a-b)/86400000)};
