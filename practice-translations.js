(()=>{
  ...
  // Practice questions used in the educational lessons.
  // Keep the English keys exact so the existing language engine can replace them.
  const entries = [
  ...
  // Re-apply the active language after adding the new dictionary entries.
