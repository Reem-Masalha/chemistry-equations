...
style.textContent=`#lesson-navigation{margin:28px 0 0}#lesson-navigation .lesson-nav-card{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:18px 20px;border:1px solid var(--line);border-radius:16px;background:var(--surface,#fff)}#lesson-navigation .lesson-progress{min-width:170px}.lesson-progress strong{display:block;font-size:14px}.lesson-progress span{display:block;margin-top:4px;color:var(--muted);font-size:13px;font-weight:700}#lesson-navigation .lesson-nav-actions{display:flex;gap:10px;flex-wrap:wrap;justify-content:flex-end}#lesson-navigation a{min-height:44px;display:inline-flex;align-items:center;justify-content:center;padding:10px 15px;border-radius:10px;text-decoration:none;font-weight:700;border:1px solid var(--accent);box-sizing:border-box;background:var(--accent);color:#fff!important}.lesson-nav-prev,.lesson-nav-next{background:var(--accent)!important;border-color:var(--accent)!important;color:#fff!important}.equation{padding:28px 36px!important;margin:24px 0!important;line-height:1.5!important;box-sizing:border-box!important}.card .equation{margin-left:0!important;margin-right:0!important}@media(max-width:620px){#lesson-navigation .lesson-nav-card{align-items:stretch;flex-direction:column}#lesson-navigation .lesson-nav-actions{justify-content:stretch}#lesson-navigation a{width:100%}.equation{padding:22px 24px!important;margin:20px 0!important;line-height:1.5!important}}`;
