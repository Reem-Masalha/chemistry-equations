...
const addEquationSpace=()=>document.querySelectorAll('.equation').forEach(el=>{
  el.style.setProperty('padding','28px 36px','important');
  el.style.setProperty('margin','24px 0','important');
  el.style.setProperty('line-height','1.5','important');
  el.style.setProperty('box-sizing','border-box','important');
});
addEquationSpace();
new MutationObserver(addEquationSpace).observe(document.documentElement,{childList:true,subtree:true});
