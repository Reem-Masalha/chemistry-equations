...
const isAdminReplay=()=>{try{return sessionStorage.getItem('chemistryAdminSession')==='1'&&new URLSearchParams(location.search).has('adminReplay')}catch{return false}};
...
function mount(){
 ...
 if(adminReplay)clearChallengeState();
 const qs=questions();
 let state=read();
