...
style.textContent=`
/* Keep the complete flat navigation visible without letting it run underneath Account. */
...
.topbar.topbar>.main-nav.main-nav{grid-column:2!important;grid-row:1!important;order:2!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;flex-wrap:nowrap!important;gap:2px!important;width:100%!important;min-width:0!important;max-width:100%!important;overflow:hidden!important;white-space:nowrap!important;position:relative!important;z-index:1!important}
...
@media(max-width:1200px){
  ...
  .topbar.topbar>.topbar-controls #accountTopBtn{max-width:105px!important}
  ...
  #site-language-control select{width:70px!important;max-width:70px!important}
}
@media(max-width:760px){
  .topbar.topbar{padding:7px 8px!important;column-gap:4px!important}
  .topbar.topbar>.brand{font-size:14px!important}
  .topbar.topbar>.main-nav.main-nav{overflow-x:auto!important;overflow-y:hidden!important;justify-content:flex-start!important;gap:2px!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important}
