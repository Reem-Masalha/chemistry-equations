...
style.textContent=`
/* Keep the original flat navigation layout. Only protect it from account overlap. */
...
.topbar.topbar>.brand{order:1!important;margin-right:auto!important;min-width:0!important;flex:0 1 auto!important;white-space:nowrap!important}
.topbar.topbar>.main-nav.main-nav{order:2!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;flex:0 1 auto!important;min-width:0!important;max-width:none!important;overflow:visible!important;flex-wrap:nowrap!important;gap:7px!important;white-space:nowrap!important;position:relative!important;z-index:1!important}
...
@media(max-width:1200px){
  ...
  .topbar.topbar>.main-nav.main-nav{flex:1 1 auto!important;min-width:0!important;overflow-x:auto!important;overflow-y:hidden!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important}
...
@media(max-width:760px){
  ...
  .topbar.topbar>.main-nav.main-nav{order:3!important;flex:1 0 100%!important;width:100%!important;max-width:none!important;gap:2px!important;padding:3px 0 1px!important;overflow-x:auto!important;overflow-y:hidden!important}
...
function normalize(){const nav=document.querySelector('.main-nav');if(!nav)return;const links=[...nav.querySelectorAll(':scope > a')];links.forEach(a=>{a.style.fontSize='';a.style.paddingLeft='';a.style.paddingRight=''});if(window.innerWidth<=1100){nav.style.justifyContent='flex-start';nav.style.overflowX='auto';}else{nav.style.justifyContent='flex-start';nav.style.overflowX='visible';}}
